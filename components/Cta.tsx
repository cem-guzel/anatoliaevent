        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          >
            <div className="bg-white shadow-2xl shadow-stone-200 overflow-hidden">
              ...
              {/* Harita Görsel Alanı (iframe veya statik görsel) */}
              <div className="w-full h-56 bg-stone-100 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="bg-stone-900 text-white px-4 py-2 text-xs tracking-widest uppercase flex items-center gap-2 shadow-lg">
              ...
              <div className="p-8 flex flex-col gap-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-700 text-sm font-light leading-relaxed">
                      Kemerburgaz, Eyüpsultan<br />İstanbul
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+905XXXXXXXXX" className="text-stone-700 text-sm font-light hover:text-stone-900 transition-colors">
                      +90 5XX XXX XX XX
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-700 text-sm font-light">Pazartesi – Cumartesi, 09:00 – 19:00</p>
                  </div>
                </div>
              </div>
            </div>
